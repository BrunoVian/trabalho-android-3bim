...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE PEDIDO (CODIGO INTEGER PRIMARY KEY AUTOINCREMENT, CODPESSOA INTEGER, VLRTOTAL DOUBLE, FOREIGN KEY (CODPESSOA) REFERENCES CLIENTE(CODIGO))");
